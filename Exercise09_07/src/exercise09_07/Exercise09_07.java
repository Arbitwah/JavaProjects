//Name:Gregory Pugh
//Assignment: "Exercise 9.07
//Date: June 18,2019
//Instructor:(The Account class) Design a class named Account that contains:
...
public class Exercise09_07 {
    public static void main(String[] args) {
        Account customer = new Account(1122,20000.00);
        ...
        (
                ...
                +"\nMonthly Interest: $"+String.format("%.2f",customer.getMonthlyInterest())
                +"%n"
        );
